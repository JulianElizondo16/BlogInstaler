...
declare class Editor extends ClassicEditor {
    ...
    simpleUpload: {
        ...
        // Headers sent along with the XMLHttpReq
    };
    fontColor: {
            options: ['automatic', 'red', 'blue', 'green']
        };
        fontSize: {
            options: ['small', 'normal', 'big', 'huge']
        };
